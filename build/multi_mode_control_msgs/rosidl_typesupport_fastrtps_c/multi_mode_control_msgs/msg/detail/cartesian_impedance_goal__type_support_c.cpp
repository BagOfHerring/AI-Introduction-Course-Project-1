...
bool cdr_serialize_multi_mode_control_msgs__msg__CartesianImpedanceGoal(
  const multi_mode_control_msgs__msg__CartesianImpedanceGoal * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: pose
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_multi_mode_control_msgs
bool cdr_deserialize_multi_mode_control_msgs__msg__CartesianImpedanceGoal(
  eprosima::fastcdr::Cdr & cdr,
  multi_mode_control_msgs__msg__CartesianImpedanceGoal * ros_message)
{
  // Field name: pose
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_multi_mode_control_msgs
bool cdr_serialize_key_multi_mode_control_msgs__msg__CartesianImpedanceGoal(
  const multi_mode_control_msgs__msg__CartesianImpedanceGoal * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: pose
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_multi_mode_control_msgs
size_t get_serialized_size_key_multi_mode_control_msgs__msg__CartesianImpedanceGoal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CartesianImpedanceGoal__ros_msg_type * ros_message = static_cast<const _CartesianImpedanceGoal__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_multi_mode_control_msgs
size_t max_serialized_size_key_multi_mode_control_msgs__msg__CartesianImpedanceGoal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const multi_mode_control_msgs__msg__CartesianImpedanceGoal * ros_message = static_cast<const multi_mode_control_msgs__msg__CartesianImpedanceGoal *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_multi_mode_control_msgs__msg__CartesianImpedanceGoal(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  multi_mode_control_msgs__msg__CartesianImpedanceGoal * ros_message = static_cast<multi_mode_control_msgs__msg__CartesianImpedanceGoal *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_multi_mode_control_msgs__msg__CartesianImpedanceGoal(cdr, ros_message);
}
