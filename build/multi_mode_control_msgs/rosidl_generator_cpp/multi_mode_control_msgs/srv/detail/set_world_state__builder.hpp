...
class Init_SetWorldState_Event_response
{
public:
  explicit Init_SetWorldState_Event_response(::multi_mode_control_msgs::srv::SetWorldState_Event & msg)
  : msg_(msg)
  {}
  ::multi_mode_control_msgs::srv::SetWorldState_Event response(::multi_mode_control_msgs::srv::SetWorldState_Event::_response_type arg)
  {
...
private:
  ::multi_mode_control_msgs::srv::SetWorldState_Event msg_;
};

class Init_SetWorldState_Event_request
{
public:
  explicit Init_SetWorldState_Event_request(::multi_mode_control_msgs::srv::SetWorldState_Event & msg)
  : msg_(msg)
  {}
  Init_SetWorldState_Event_response request(::multi_mode_control_msgs::srv::SetWorldState_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetWorldState_Event_response(msg_);
  }
...
class Init_SetWorldState_Event_info
{
public:
  Init_SetWorldState_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetWorldState_Event_request info(::multi_mode_control_msgs::srv::SetWorldState_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetWorldState_Event_request(msg_);
  }
...
template<>
inline
auto build<::multi_mode_control_msgs::srv::SetWorldState_Event>()
{
  return multi_mode_control_msgs::srv::builder::Init_SetWorldState_Event_info();
}
