...
class Metaclass_GetRobotStates_Event(type):
    """Metaclass of message 'GetRobotStates_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_robot_states__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_robot_states__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_robot_states__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_robot_states__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_robot_states__event
...
class GetRobotStates_Event(metaclass=Metaclass_GetRobotStates_Event):
    """Message class 'GetRobotStates_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<multi_mode_control_msgs/GetRobotStates_Request, 1>',
        'response': 'sequence<multi_mode_control_msgs/GetRobotStates_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['multi_mode_control_msgs', 'srv'], 'GetRobotStates_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['multi_mode_control_msgs', 'srv'], 'GetRobotStates_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from multi_mode_control_msgs.srv import GetRobotStates_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetRobotStates_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetRobotStates_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from multi_mode_control_msgs.srv import GetRobotStates_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetRobotStates_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetRobotStates_Response'"
...
class Metaclass_GetRobotStates(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_robot_states.Metaclass_GetRobotStates_Event._TYPE_SUPPORT is None:
                _get_robot_states.Metaclass_GetRobotStates_Event.__import_type_support__()
...
class GetRobotStates(metaclass=Metaclass_GetRobotStates):
    ...
    from multi_mode_control_msgs.srv._get_robot_states import GetRobotStates_Event as Event
