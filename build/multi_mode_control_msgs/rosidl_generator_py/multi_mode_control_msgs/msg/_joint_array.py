...
class Metaclass_JointArray(type):
    """Metaclass of message 'JointArray'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__joint_array
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__joint_array
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__joint_array
            cls._TYPE_SUPPORT = module.type_support_msg__msg__joint_array
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__joint_array
...
class JointArray(metaclass=Metaclass_JointArray):
    """Message class 'JointArray'."""
    ...
    def __init__(self, **kwargs):
        ...
        if 'data' not in kwargs:
            self.data = numpy.zeros(7, dtype=numpy.float64)
        else:
