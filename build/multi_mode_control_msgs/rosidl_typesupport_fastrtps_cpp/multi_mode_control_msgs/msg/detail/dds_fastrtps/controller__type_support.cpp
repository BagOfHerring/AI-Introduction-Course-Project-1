...
#include "multi_mode_control_msgs/msg/detail/controller__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const multi_mode_control_msgs::msg::Controller & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_mode_control_msgs::msg::Controller & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  // Member: resources
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.resources[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_mode_control_msgs::msg::Controller;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const multi_mode_control_msgs::msg::Controller *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<multi_mode_control_msgs::msg::Controller *>(
    untyped_ros_message);
...
{
  return &multi_mode_control_msgs::msg::typesupport_fastrtps_cpp::_Controller__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_mode_control_msgs, msg, Controller)() {
  return &multi_mode_control_msgs::msg::typesupport_fastrtps_cpp::_Controller__handle;
}
