...
#include "multi_mode_control_msgs/msg/detail/joint_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const multi_mode_control_msgs::msg::JointArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  multi_mode_control_msgs::msg::JointArray & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_mode_control_msgs::msg::JointArray;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_multi_mode_control_msgs
max_serialized_size_key_JointArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const multi_mode_control_msgs::msg::JointArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<multi_mode_control_msgs::msg::JointArray *>(
    untyped_ros_message);
...
{
  return &multi_mode_control_msgs::msg::typesupport_fastrtps_cpp::_JointArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, multi_mode_control_msgs, msg, JointArray)() {
  return &multi_mode_control_msgs::msg::typesupport_fastrtps_cpp::_JointArray__handle;
}
