  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const panda_motion_generator_msgs__msg__SimpleActionResult * ros_message = static_cast<const panda_motion_generator_msgs__msg__SimpleActionResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_panda_motion_generator_msgs__msg__SimpleActionResult(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  panda_motion_generator_msgs__msg__SimpleActionResult * ros_message = static_cast<panda_motion_generator_msgs__msg__SimpleActionResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_panda_motion_generator_msgs__msg__SimpleActionResult(cdr, ros_message);
}
