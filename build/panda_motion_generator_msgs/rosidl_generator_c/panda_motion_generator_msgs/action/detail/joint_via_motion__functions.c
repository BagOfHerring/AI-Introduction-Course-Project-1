...
panda_motion_generator_msgs__action__JointViaMotion_Goal__create(void)
{
...
panda_motion_generator_msgs__action__JointViaMotion_Result__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
panda_motion_generator_msgs__action__JointViaMotion_Feedback__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Request__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__init(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
void
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__fini(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Response__Sequence__fini(&msg->response);
}

bool
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__are_equal(const panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * lhs, const panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Response__Sequence__are_equal(
...
bool
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__copy(
  const panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * input,
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Response__Sequence__copy(
...
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event *
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * msg = (panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event *)allocator.allocate(sizeof(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event));
  bool success = panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__destroy(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__fini(msg);
...
bool
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence__init(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * data = NULL;

  if (size) {
    data = (panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event *)allocator.zero_allocate(size, sizeof(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence__fini(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence *
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence * array = (panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence *)allocator.allocate(sizeof(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence__destroy(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence__are_equal(const panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence * lhs, const panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence__copy(
  const panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence * input,
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event * data =
      (panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Request__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__init(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * msg)
{
  if (!msg) {
    return false;
  }
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Request__Sequence__init(&msg->request, 0)) {
    panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Response__Sequence__init(&msg->response, 0)) {
    panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
void
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__fini(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Request__Sequence__fini(&msg->request);
  // response
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Response__Sequence__fini(&msg->response);
}

bool
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__are_equal(const panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * lhs, const panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
...
bool
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__copy(
  const panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * input,
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event *
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * msg = (panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event *)allocator.allocate(sizeof(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event));
  bool success = panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__destroy(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__fini(msg);
...
bool
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence__init(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * data = NULL;

  if (size) {
    data = (panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event *)allocator.zero_allocate(size, sizeof(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence__fini(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence *
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence * array = (panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence *)allocator.allocate(sizeof(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence__destroy(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence__are_equal(const panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence * lhs, const panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence__copy(
  const panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence * input,
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event * data =
      (panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
panda_motion_generator_msgs__action__JointViaMotion_FeedbackMessage__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
