...
static const _GetGravity_Request_type_support_symbol_names_t _GetGravity_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mujoco_ros_msgs, srv, GetGravity_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetGravity_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mujoco_ros_msgs, srv, GetGravity_Request)() {
  return &::mujoco_ros_msgs::srv::rosidl_typesupport_c::GetGravity_Request_message_type_support_handle;
}
...
static const _GetGravity_Response_type_support_symbol_names_t _GetGravity_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mujoco_ros_msgs, srv, GetGravity_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetGravity_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mujoco_ros_msgs, srv, GetGravity_Response)() {
  return &::mujoco_ros_msgs::srv::rosidl_typesupport_c::GetGravity_Response_message_type_support_handle;
}
...
typedef struct _GetGravity_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _GetGravity_Event_type_support_ids_t;

static const _GetGravity_Event_type_support_ids_t _GetGravity_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _GetGravity_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _GetGravity_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _GetGravity_Event_type_support_symbol_names_t _GetGravity_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mujoco_ros_msgs, srv, GetGravity_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetGravity_Event)),
  }
};

typedef struct _GetGravity_Event_type_support_data_t
{
  void * data[2];
} _GetGravity_Event_type_support_data_t;

static _GetGravity_Event_type_support_data_t _GetGravity_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _GetGravity_Event_message_typesupport_map = {
  2,
  "mujoco_ros_msgs",
  &_GetGravity_Event_message_typesupport_ids.typesupport_identifier[0],
  &_GetGravity_Event_message_typesupport_symbol_names.symbol_name[0],
  &_GetGravity_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t GetGravity_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_GetGravity_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mujoco_ros_msgs, srv, GetGravity_Event)() {
  return &::mujoco_ros_msgs::srv::rosidl_typesupport_c::GetGravity_Event_message_type_support_handle;
}
...
static const _GetGravity_type_support_symbol_names_t _GetGravity_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mujoco_ros_msgs, srv, GetGravity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetGravity)),
  }
};
...
static const rosidl_service_type_support_t GetGravity_service_type_support_handle = {
  ...
  &GetGravity_Request_message_type_support_handle,
  &GetGravity_Response_message_type_support_handle,
  &GetGravity_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mujoco_ros_msgs, srv, GetGravity)() {
  return &::mujoco_ros_msgs::srv::rosidl_typesupport_c::GetGravity_service_type_support_handle;
}
