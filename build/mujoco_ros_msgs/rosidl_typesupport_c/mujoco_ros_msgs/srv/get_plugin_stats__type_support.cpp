...
static const _GetPluginStats_Event_type_support_symbol_names_t _GetPluginStats_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mujoco_ros_msgs, srv, GetPluginStats_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetPluginStats_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mujoco_ros_msgs, srv, GetPluginStats_Event)() {
  return &::mujoco_ros_msgs::srv::rosidl_typesupport_c::GetPluginStats_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetPluginStats_service_type_support_handle = {
  ...
  &GetPluginStats_Request_message_type_support_handle,
  &GetPluginStats_Response_message_type_support_handle,
  &GetPluginStats_Event_message_type_support_handle,
