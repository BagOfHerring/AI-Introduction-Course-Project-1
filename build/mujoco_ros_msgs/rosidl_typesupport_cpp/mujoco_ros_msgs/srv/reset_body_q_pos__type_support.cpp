...
static const _ResetBodyQPos_Event_type_support_symbol_names_t _ResetBodyQPos_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mujoco_ros_msgs, srv, ResetBodyQPos_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mujoco_ros_msgs, srv, ResetBodyQPos_Event)),
  }
};
...
{
  return &::mujoco_ros_msgs::srv::rosidl_typesupport_cpp::ResetBodyQPos_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mujoco_ros_msgs, srv, ResetBodyQPos_Event)() {
  return get_message_type_support_handle<mujoco_ros_msgs::srv::ResetBodyQPos_Event>();
}
...
static const rosidl_service_type_support_t ResetBodyQPos_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mujoco_ros_msgs::srv::ResetBodyQPos_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mujoco_ros_msgs::srv::ResetBodyQPos_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mujoco_ros_msgs::srv::ResetBodyQPos_Event>(),
