...
void mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__init(message_memory);
}

void mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_fini_function(void * message_memory)
{
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__fini(message_memory);
}

size_t mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__size_function__GetEqualityConstraintParameters_Event__request(
  const void * untyped_member)
{
  const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence * member =
    (const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetEqualityConstraintParameters_Event__request(
  const void * untyped_member, size_t index)
{
  const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence * member =
    (const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence *)(untyped_member);
...
void * mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_function__GetEqualityConstraintParameters_Event__request(
  void * untyped_member, size_t index)
{
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence * member =
    (mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__fetch_function__GetEqualityConstraintParameters_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request * item =
    ((const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request *)
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetEqualityConstraintParameters_Event__request(untyped_member, index));
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request * value =
    (mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request *)(untyped_value);
  *value = *item;
}

void mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__assign_function__GetEqualityConstraintParameters_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request * item =
    ((mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request *)
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_function__GetEqualityConstraintParameters_Event__request(untyped_member, index));
  const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request * value =
    (const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request *)(untyped_value);
  *item = *value;
}

bool mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__resize_function__GetEqualityConstraintParameters_Event__request(
  void * untyped_member, size_t size)
{
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence * member =
    (mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence *)(untyped_member);
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence__fini(member);
  return mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__Sequence__init(member, size);
}

size_t mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__size_function__GetEqualityConstraintParameters_Event__response(
  const void * untyped_member)
{
  const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence * member =
    (const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetEqualityConstraintParameters_Event__response(
  const void * untyped_member, size_t index)
{
  const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence * member =
    (const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence *)(untyped_member);
...
void * mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_function__GetEqualityConstraintParameters_Event__response(
  void * untyped_member, size_t index)
{
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence * member =
    (mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__fetch_function__GetEqualityConstraintParameters_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response * item =
    ((const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response *)
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetEqualityConstraintParameters_Event__response(untyped_member, index));
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response * value =
    (mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response *)(untyped_value);
  *value = *item;
}

void mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__assign_function__GetEqualityConstraintParameters_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response * item =
    ((mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response *)
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_function__GetEqualityConstraintParameters_Event__response(untyped_member, index));
  const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response * value =
    (const mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response *)(untyped_value);
  *item = *value;
}

bool mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__resize_function__GetEqualityConstraintParameters_Event__response(
  void * untyped_member, size_t size)
{
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence * member =
    (mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence *)(untyped_member);
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence__fini(member);
  return mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event, request),  // bytes offset in struct
    NULL,  // default value
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__size_function__GetEqualityConstraintParameters_Event__request,  // size() function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetEqualityConstraintParameters_Event__request,  // get_const(index) function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_function__GetEqualityConstraintParameters_Event__request,  // get(index) function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__fetch_function__GetEqualityConstraintParameters_Event__request,  // fetch(index, &value) function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__assign_function__GetEqualityConstraintParameters_Event__request,  // assign(index, value) function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__resize_function__GetEqualityConstraintParameters_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event, response),  // bytes offset in struct
    NULL,  // default value
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__size_function__GetEqualityConstraintParameters_Event__response,  // size() function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_const_function__GetEqualityConstraintParameters_Event__response,  // get_const(index) function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__get_function__GetEqualityConstraintParameters_Event__response,  // get(index) function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__fetch_function__GetEqualityConstraintParameters_Event__response,  // fetch(index, &value) function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__assign_function__GetEqualityConstraintParameters_Event__response,  // assign(index, value) function pointer
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__resize_function__GetEqualityConstraintParameters_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_members = {
  "mujoco_ros_msgs__srv",  // message namespace
  "GetEqualityConstraintParameters_Event",  // message name
  3,  // number of fields
  sizeof(mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event),
  false,  // has_any_key_member_
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_member_array,  // message members
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_type_support_handle = {
  0,
  &mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_mujoco_ros_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetEqualityConstraintParameters_Event)() {
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetEqualityConstraintParameters_Request)();
  mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetEqualityConstraintParameters_Response)();
  if (!mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_type_support_handle.typesupport_identifier) {
    mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t mujoco_ros_msgs__srv__detail__get_equality_constraint_parameters__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_service_type_support_handle = {
  ...
  &mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Request__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Request_message_type_support_handle,
  &mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Response__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Response_message_type_support_handle,
  &mujoco_ros_msgs__srv__GetEqualityConstraintParameters_Event__rosidl_typesupport_introspection_c__GetEqualityConstraintParameters_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetEqualityConstraintParameters_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetEqualityConstraintParameters_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetEqualityConstraintParameters_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_mujoco_ros_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetEqualityConstraintParameters)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetEqualityConstraintParameters_Event)()->data;
  }
