...
class Metaclass_SetPause_Event(type):
    """Metaclass of message 'SetPause_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_pause__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_pause__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_pause__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_pause__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_pause__event
...
class SetPause_Event(metaclass=Metaclass_SetPause_Event):
    """Message class 'SetPause_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mujoco_ros_msgs/SetPause_Request, 1>',
        'response': 'sequence<mujoco_ros_msgs/SetPause_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mujoco_ros_msgs', 'srv'], 'SetPause_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mujoco_ros_msgs', 'srv'], 'SetPause_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mujoco_ros_msgs.srv import SetPause_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetPause_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetPause_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from mujoco_ros_msgs.srv import SetPause_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetPause_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetPause_Response'"
...
class Metaclass_SetPause(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mujoco_ros_msgs.srv import _set_pause
            ...
            if _set_pause.Metaclass_SetPause_Event._TYPE_SUPPORT is None:
                _set_pause.Metaclass_SetPause_Event.__import_type_support__()


class SetPause(metaclass=Metaclass_SetPause):
    from mujoco_ros_msgs.srv._set_pause import SetPause_Request as Request
    from mujoco_ros_msgs.srv._set_pause import SetPause_Response as Response
    from mujoco_ros_msgs.srv._set_pause import SetPause_Event as Event
