...
class Metaclass_GetSimInfo_Event(type):
    """Metaclass of message 'GetSimInfo_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_sim_info__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_sim_info__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_sim_info__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_sim_info__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_sim_info__event
...
class GetSimInfo_Event(metaclass=Metaclass_GetSimInfo_Event):
    """Message class 'GetSimInfo_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mujoco_ros_msgs/GetSimInfo_Request, 1>',
        'response': 'sequence<mujoco_ros_msgs/GetSimInfo_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mujoco_ros_msgs', 'srv'], 'GetSimInfo_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mujoco_ros_msgs', 'srv'], 'GetSimInfo_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mujoco_ros_msgs.srv import GetSimInfo_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetSimInfo_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetSimInfo_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from mujoco_ros_msgs.srv import GetSimInfo_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetSimInfo_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetSimInfo_Response'"
...
class Metaclass_GetSimInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_sim_info.Metaclass_GetSimInfo_Event._TYPE_SUPPORT is None:
                _get_sim_info.Metaclass_GetSimInfo_Event.__import_type_support__()
...
class GetSimInfo(metaclass=Metaclass_GetSimInfo):
    ...
    from mujoco_ros_msgs.srv._get_sim_info import GetSimInfo_Event as Event
