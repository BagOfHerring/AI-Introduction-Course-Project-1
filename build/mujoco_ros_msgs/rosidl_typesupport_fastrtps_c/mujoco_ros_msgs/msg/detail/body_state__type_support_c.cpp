...
#include "mujoco_ros_msgs/msg/detail/body_state__rosidl_typesupport_fastrtps_c.h"
...
using _BodyState__ros_msg_type = mujoco_ros_msgs__msg__BodyState;
  ...
  mujoco_ros_msgs__msg__BodyState * ros_message)
{
  ...
  // Field name: twist
  {
    cdr_deserialize_geometry_msgs__msg__TwistStamped(cdr, &ros_message->twist);
  }
...
size_t get_serialized_size_mujoco_ros_msgs__msg__BodyState(
  ...
  size_t current_alignment)
{
  const _BodyState__ros_msg_type * ros_message = static_cast<const _BodyState__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mujoco_ros_msgs__msg__BodyState;
    is_plain =
      (
...
static bool _BodyState__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mujoco_ros_msgs__msg__BodyState * ros_message = static_cast<const mujoco_ros_msgs__msg__BodyState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mujoco_ros_msgs__msg__BodyState(ros_message, cdr);
}

static bool _BodyState__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  mujoco_ros_msgs__msg__BodyState * ros_message = static_cast<mujoco_ros_msgs__msg__BodyState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mujoco_ros_msgs__msg__BodyState(cdr, ros_message);
}

static uint32_t _BodyState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mujoco_ros_msgs__msg__BodyState(
      untyped_ros_message, 0));
}

static size_t _BodyState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_mujoco_ros_msgs__msg__BodyState(
...
static message_type_support_callbacks_t __callbacks_BodyState = {
  "mujoco_ros_msgs::msg",
  "BodyState",
  _BodyState__cdr_serialize,
  _BodyState__cdr_deserialize,
  _BodyState__get_serialized_size,
  _BodyState__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _BodyState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BodyState,
  get_message_typesupport_handle_function,
  &mujoco_ros_msgs__msg__BodyState__get_type_hash,
  &mujoco_ros_msgs__msg__BodyState__get_type_description,
  &mujoco_ros_msgs__msg__BodyState__get_type_description_sources,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mujoco_ros_msgs, msg, BodyState)() {
  return &_BodyState__type_support;
}
