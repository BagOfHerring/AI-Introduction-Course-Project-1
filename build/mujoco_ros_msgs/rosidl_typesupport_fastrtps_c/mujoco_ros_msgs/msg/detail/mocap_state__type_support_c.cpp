...
#include "mujoco_ros_msgs/msg/detail/mocap_state__rosidl_typesupport_fastrtps_c.h"
...
using _MocapState__ros_msg_type = mujoco_ros_msgs__msg__MocapState;
  ...
  mujoco_ros_msgs__msg__MocapState * ros_message)
{
  ...
  // Field name: pose
  {
    ...
    if (ros_message->pose.data) {
      geometry_msgs__msg__PoseStamped__Sequence__fini(&ros_message->pose);
    }
    if (!geometry_msgs__msg__PoseStamped__Sequence__init(&ros_message->pose, size)) {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mujoco_ros_msgs__msg__MocapState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mujoco_ros_msgs__msg__MocapState * ros_message = static_cast<const mujoco_ros_msgs__msg__MocapState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mujoco_ros_msgs__msg__MocapState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mujoco_ros_msgs__msg__MocapState * ros_message = static_cast<mujoco_ros_msgs__msg__MocapState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mujoco_ros_msgs__msg__MocapState(cdr, ros_message);
}

static uint32_t _MocapState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mujoco_ros_msgs__msg__MocapState(
...
static size_t _MocapState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mujoco_ros_msgs__msg__MocapState(
...
static rosidl_message_type_support_t _MocapState__type_support = {
  ...
  &mujoco_ros_msgs__msg__MocapState__get_type_hash,
  &mujoco_ros_msgs__msg__MocapState__get_type_description,
  &mujoco_ros_msgs__msg__MocapState__get_type_description_sources,
};
