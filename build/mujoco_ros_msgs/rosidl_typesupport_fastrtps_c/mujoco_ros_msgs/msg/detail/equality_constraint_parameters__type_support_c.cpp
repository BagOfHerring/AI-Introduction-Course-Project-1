...
bool cdr_serialize_mujoco_ros_msgs__msg__EqualityConstraintType(
  const mujoco_ros_msgs__msg__EqualityConstraintType * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_mujoco_ros_msgs__msg__EqualityConstraintType(
  eprosima::fastcdr::Cdr & cdr,
  mujoco_ros_msgs__msg__EqualityConstraintType * ros_message);
...
bool cdr_serialize_key_mujoco_ros_msgs__msg__EqualityConstraintType(
  const mujoco_ros_msgs__msg__EqualityConstraintType * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_mujoco_ros_msgs__msg__EqualityConstraintType(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_mujoco_ros_msgs__msg__EqualityConstraintType(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_mujoco_ros_msgs__msg__SolverParameters(
  const mujoco_ros_msgs__msg__SolverParameters * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_mujoco_ros_msgs__msg__SolverParameters(
  eprosima::fastcdr::Cdr & cdr,
  mujoco_ros_msgs__msg__SolverParameters * ros_message);
...
bool cdr_serialize_key_mujoco_ros_msgs__msg__SolverParameters(
  const mujoco_ros_msgs__msg__SolverParameters * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_mujoco_ros_msgs__msg__SolverParameters(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_mujoco_ros_msgs__msg__SolverParameters(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: type
  {
    cdr_serialize_mujoco_ros_msgs__msg__EqualityConstraintType(
      &ros_message->type, cdr);
  }

  // Field name: solver_parameters
  {
    cdr_serialize_mujoco_ros_msgs__msg__SolverParameters(
  ...
  mujoco_ros_msgs__msg__EqualityConstraintParameters * ros_message)
{
  ...
  // Field name: type
  {
    cdr_deserialize_mujoco_ros_msgs__msg__EqualityConstraintType(cdr, &ros_message->type);
  }

  // Field name: solver_parameters
  {
    cdr_deserialize_mujoco_ros_msgs__msg__SolverParameters(cdr, &ros_message->solver_parameters);
  }
  ...
  // Field name: anchor
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->anchor);
  }

  // Field name: relpose
  {
    cdr_deserialize_geometry_msgs__msg__Pose(cdr, &ros_message->relpose);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: type
  {
    cdr_serialize_key_mujoco_ros_msgs__msg__EqualityConstraintType(
      &ros_message->type, cdr);
  }

  // Field name: solver_parameters
  {
    cdr_serialize_key_mujoco_ros_msgs__msg__SolverParameters(
      &ros_message->solver_parameters, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: type
  current_alignment += get_serialized_size_key_mujoco_ros_msgs__msg__EqualityConstraintType(
    &(ros_message->type), current_alignment);

  // Field name: solver_parameters
  current_alignment += get_serialized_size_key_mujoco_ros_msgs__msg__SolverParameters(
    &(ros_message->solver_parameters), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: type
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mujoco_ros_msgs__msg__EqualityConstraintType(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: solver_parameters
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mujoco_ros_msgs__msg__SolverParameters(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mujoco_ros_msgs__msg__EqualityConstraintParameters * ros_message = static_cast<const mujoco_ros_msgs__msg__EqualityConstraintParameters *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mujoco_ros_msgs__msg__EqualityConstraintParameters(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mujoco_ros_msgs__msg__EqualityConstraintParameters * ros_message = static_cast<mujoco_ros_msgs__msg__EqualityConstraintParameters *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mujoco_ros_msgs__msg__EqualityConstraintParameters(cdr, ros_message);
}
