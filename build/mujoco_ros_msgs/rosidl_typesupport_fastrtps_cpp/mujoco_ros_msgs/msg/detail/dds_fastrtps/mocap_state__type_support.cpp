...
#include "mujoco_ros_msgs/msg/detail/mocap_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mujoco_ros_msgs::msg::MocapState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mujoco_ros_msgs::msg::MocapState & ros_message)
{
  // Member: name
  {
    cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mujoco_ros_msgs::msg::MocapState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mujoco_ros_msgs::msg::MocapState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mujoco_ros_msgs::msg::MocapState *>(
    untyped_ros_message);
...
{
  return &mujoco_ros_msgs::msg::typesupport_fastrtps_cpp::_MocapState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mujoco_ros_msgs, msg, MocapState)() {
  return &mujoco_ros_msgs::msg::typesupport_fastrtps_cpp::_MocapState__handle;
}
