...
#include "mujoco_ros_msgs/msg/detail/scalar_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mujoco_ros_msgs::msg::ScalarStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mujoco_ros_msgs::msg::ScalarStamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mujoco_ros_msgs::msg::ScalarStamped;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mujoco_ros_msgs
max_serialized_size_key_ScalarStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mujoco_ros_msgs::msg::ScalarStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mujoco_ros_msgs::msg::ScalarStamped *>(
    untyped_ros_message);
...
{
  return &mujoco_ros_msgs::msg::typesupport_fastrtps_cpp::_ScalarStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mujoco_ros_msgs, msg, ScalarStamped)() {
  return &mujoco_ros_msgs::msg::typesupport_fastrtps_cpp::_ScalarStamped__handle;
}
