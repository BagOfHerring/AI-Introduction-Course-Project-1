...
class Init_Step_SendGoal_Event_response
{
public:
  explicit Init_Step_SendGoal_Event_response(::mujoco_ros_msgs::action::Step_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::mujoco_ros_msgs::action::Step_SendGoal_Event response(::mujoco_ros_msgs::action::Step_SendGoal_Event::_response_type arg)
  {
...
private:
  ::mujoco_ros_msgs::action::Step_SendGoal_Event msg_;
};

class Init_Step_SendGoal_Event_request
{
public:
  explicit Init_Step_SendGoal_Event_request(::mujoco_ros_msgs::action::Step_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Step_SendGoal_Event_response request(::mujoco_ros_msgs::action::Step_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Step_SendGoal_Event_response(msg_);
  }
...
class Init_Step_SendGoal_Event_info
{
public:
  Init_Step_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Step_SendGoal_Event_request info(::mujoco_ros_msgs::action::Step_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Step_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::mujoco_ros_msgs::action::Step_SendGoal_Event>()
{
  return mujoco_ros_msgs::action::builder::Init_Step_SendGoal_Event_info();
}
...
class Init_Step_GetResult_Event_response
{
public:
  explicit Init_Step_GetResult_Event_response(::mujoco_ros_msgs::action::Step_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::mujoco_ros_msgs::action::Step_GetResult_Event response(::mujoco_ros_msgs::action::Step_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::mujoco_ros_msgs::action::Step_GetResult_Event msg_;
};

class Init_Step_GetResult_Event_request
{
public:
  explicit Init_Step_GetResult_Event_request(::mujoco_ros_msgs::action::Step_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Step_GetResult_Event_response request(::mujoco_ros_msgs::action::Step_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Step_GetResult_Event_response(msg_);
  }
...
class Init_Step_GetResult_Event_info
{
public:
  Init_Step_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Step_GetResult_Event_request info(::mujoco_ros_msgs::action::Step_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Step_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::mujoco_ros_msgs::action::Step_GetResult_Event>()
{
  return mujoco_ros_msgs::action::builder::Init_Step_GetResult_Event_info();
}
