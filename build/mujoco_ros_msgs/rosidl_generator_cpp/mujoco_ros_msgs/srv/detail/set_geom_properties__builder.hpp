...
class Init_SetGeomProperties_Event_response
{
public:
  explicit Init_SetGeomProperties_Event_response(::mujoco_ros_msgs::srv::SetGeomProperties_Event & msg)
  : msg_(msg)
  {}
  ::mujoco_ros_msgs::srv::SetGeomProperties_Event response(::mujoco_ros_msgs::srv::SetGeomProperties_Event::_response_type arg)
  {
...
private:
  ::mujoco_ros_msgs::srv::SetGeomProperties_Event msg_;
};

class Init_SetGeomProperties_Event_request
{
public:
  explicit Init_SetGeomProperties_Event_request(::mujoco_ros_msgs::srv::SetGeomProperties_Event & msg)
  : msg_(msg)
  {}
  Init_SetGeomProperties_Event_response request(::mujoco_ros_msgs::srv::SetGeomProperties_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetGeomProperties_Event_response(msg_);
  }
...
class Init_SetGeomProperties_Event_info
{
public:
  Init_SetGeomProperties_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetGeomProperties_Event_request info(::mujoco_ros_msgs::srv::SetGeomProperties_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetGeomProperties_Event_request(msg_);
  }
...
template<>
inline
auto build<::mujoco_ros_msgs::srv::SetGeomProperties_Event>()
{
  return mujoco_ros_msgs::srv::builder::Init_SetGeomProperties_Event_info();
}
