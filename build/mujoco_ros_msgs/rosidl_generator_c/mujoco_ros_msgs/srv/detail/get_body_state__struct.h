...
enum
{
  mujoco_ros_msgs__srv__GetBodyState_Event__request__MAX_SIZE = 1
};
// response
enum
{
  mujoco_ros_msgs__srv__GetBodyState_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetBodyState in the package mujoco_ros_msgs.
typedef struct mujoco_ros_msgs__srv__GetBodyState_Event
{
  service_msgs__msg__ServiceEventInfo info;
  mujoco_ros_msgs__srv__GetBodyState_Request__Sequence request;
  mujoco_ros_msgs__srv__GetBodyState_Response__Sequence response;
} mujoco_ros_msgs__srv__GetBodyState_Event;

// Struct for a sequence of mujoco_ros_msgs__srv__GetBodyState_Event.
typedef struct mujoco_ros_msgs__srv__GetBodyState_Event__Sequence
{
