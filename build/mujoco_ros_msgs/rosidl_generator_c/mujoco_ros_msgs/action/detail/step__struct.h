...
enum
{
  mujoco_ros_msgs__action__Step_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  mujoco_ros_msgs__action__Step_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Step in the package mujoco_ros_msgs.
typedef struct mujoco_ros_msgs__action__Step_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  mujoco_ros_msgs__action__Step_SendGoal_Request__Sequence request;
  mujoco_ros_msgs__action__Step_SendGoal_Response__Sequence response;
} mujoco_ros_msgs__action__Step_SendGoal_Event;

// Struct for a sequence of mujoco_ros_msgs__action__Step_SendGoal_Event.
typedef struct mujoco_ros_msgs__action__Step_SendGoal_Event__Sequence
{
...
enum
{
  mujoco_ros_msgs__action__Step_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  mujoco_ros_msgs__action__Step_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Step in the package mujoco_ros_msgs.
typedef struct mujoco_ros_msgs__action__Step_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  mujoco_ros_msgs__action__Step_GetResult_Request__Sequence request;
  mujoco_ros_msgs__action__Step_GetResult_Response__Sequence response;
} mujoco_ros_msgs__action__Step_GetResult_Event;

// Struct for a sequence of mujoco_ros_msgs__action__Step_GetResult_Event.
typedef struct mujoco_ros_msgs__action__Step_GetResult_Event__Sequence
{
