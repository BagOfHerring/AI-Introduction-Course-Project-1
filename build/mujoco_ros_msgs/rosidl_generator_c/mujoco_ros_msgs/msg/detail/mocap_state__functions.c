...
mujoco_ros_msgs__msg__MocapState__init(mujoco_ros_msgs__msg__MocapState * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->name, 0)) {
    mujoco_ros_msgs__msg__MocapState__fini(msg);
    return false;
  }
  // pose
  if (!geometry_msgs__msg__PoseStamped__Sequence__init(&msg->pose, 0)) {
    mujoco_ros_msgs__msg__MocapState__fini(msg);
    return false;
  }
  return true;
...
mujoco_ros_msgs__msg__MocapState__fini(mujoco_ros_msgs__msg__MocapState * msg)
{
  ...
  // pose
  geometry_msgs__msg__PoseStamped__Sequence__fini(&msg->pose);
}
...
mujoco_ros_msgs__msg__MocapState__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mujoco_ros_msgs__msg__MocapState * msg = (mujoco_ros_msgs__msg__MocapState *)allocator.allocate(sizeof(mujoco_ros_msgs__msg__MocapState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mujoco_ros_msgs__msg__MocapState));
  bool success = mujoco_ros_msgs__msg__MocapState__init(msg);
  if (!success) {
...
mujoco_ros_msgs__msg__MocapState__Sequence__init(mujoco_ros_msgs__msg__MocapState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mujoco_ros_msgs__msg__MocapState * data = NULL;

  if (size) {
    data = (mujoco_ros_msgs__msg__MocapState *)allocator.zero_allocate(size, sizeof(mujoco_ros_msgs__msg__MocapState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mujoco_ros_msgs__msg__MocapState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mujoco_ros_msgs__msg__MocapState__fini(&data[i - 1]);
      }
...
mujoco_ros_msgs__msg__MocapState__Sequence__fini(mujoco_ros_msgs__msg__MocapState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mujoco_ros_msgs__msg__MocapState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mujoco_ros_msgs__msg__MocapState__Sequence * array = (mujoco_ros_msgs__msg__MocapState__Sequence *)allocator.allocate(sizeof(mujoco_ros_msgs__msg__MocapState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mujoco_ros_msgs__msg__MocapState__Sequence__init(array, size);
  if (!success) {
...
mujoco_ros_msgs__msg__MocapState__Sequence__destroy(mujoco_ros_msgs__msg__MocapState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mujoco_ros_msgs__msg__MocapState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mujoco_ros_msgs__msg__MocapState__Sequence__are_equal(const mujoco_ros_msgs__msg__MocapState__Sequence * lhs, const mujoco_ros_msgs__msg__MocapState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mujoco_ros_msgs__msg__MocapState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mujoco_ros_msgs__msg__MocapState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mujoco_ros_msgs__msg__MocapState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mujoco_ros_msgs__msg__MocapState * data =
      (mujoco_ros_msgs__msg__MocapState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mujoco_ros_msgs__msg__MocapState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mujoco_ros_msgs__msg__MocapState__fini(&output->data[i]);
        }
        return false;
      }
    }
