...
class Init_Grasp_SendGoal_Event_response
{
public:
  explicit Init_Grasp_SendGoal_Event_response(::franka_msgs::action::Grasp_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::franka_msgs::action::Grasp_SendGoal_Event response(::franka_msgs::action::Grasp_SendGoal_Event::_response_type arg)
  {
...
private:
  ::franka_msgs::action::Grasp_SendGoal_Event msg_;
};

class Init_Grasp_SendGoal_Event_request
{
public:
  explicit Init_Grasp_SendGoal_Event_request(::franka_msgs::action::Grasp_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Grasp_SendGoal_Event_response request(::franka_msgs::action::Grasp_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Grasp_SendGoal_Event_response(msg_);
  }
...
class Init_Grasp_SendGoal_Event_info
{
public:
  Init_Grasp_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Grasp_SendGoal_Event_request info(::franka_msgs::action::Grasp_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Grasp_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::franka_msgs::action::Grasp_SendGoal_Event>()
{
  return franka_msgs::action::builder::Init_Grasp_SendGoal_Event_info();
}
...
class Init_Grasp_GetResult_Event_response
{
public:
  explicit Init_Grasp_GetResult_Event_response(::franka_msgs::action::Grasp_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::franka_msgs::action::Grasp_GetResult_Event response(::franka_msgs::action::Grasp_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::franka_msgs::action::Grasp_GetResult_Event msg_;
};

class Init_Grasp_GetResult_Event_request
{
public:
  explicit Init_Grasp_GetResult_Event_request(::franka_msgs::action::Grasp_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Grasp_GetResult_Event_response request(::franka_msgs::action::Grasp_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Grasp_GetResult_Event_response(msg_);
  }
...
class Init_Grasp_GetResult_Event_info
{
public:
  Init_Grasp_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Grasp_GetResult_Event_request info(::franka_msgs::action::Grasp_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Grasp_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::franka_msgs::action::Grasp_GetResult_Event>()
{
  return franka_msgs::action::builder::Init_Grasp_GetResult_Event_info();
}
