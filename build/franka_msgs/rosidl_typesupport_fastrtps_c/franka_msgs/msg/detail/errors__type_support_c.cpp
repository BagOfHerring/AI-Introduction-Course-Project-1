  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const franka_msgs__msg__Errors * ros_message = static_cast<const franka_msgs__msg__Errors *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_franka_msgs__msg__Errors(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  franka_msgs__msg__Errors * ros_message = static_cast<franka_msgs__msg__Errors *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_franka_msgs__msg__Errors(cdr, ros_message);
}
