...
static const _GraspEpsilon_type_support_symbol_names_t _GraspEpsilon_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_msgs, msg, GraspEpsilon)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, franka_msgs, msg, GraspEpsilon)),
  }
};
...
{
  return &::franka_msgs::msg::rosidl_typesupport_cpp::GraspEpsilon_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, franka_msgs, msg, GraspEpsilon)() {
  return get_message_type_support_handle<franka_msgs::msg::GraspEpsilon>();
}
