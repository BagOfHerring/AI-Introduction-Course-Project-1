...
static const _SetFullCollisionBehavior_Event_type_support_symbol_names_t _SetFullCollisionBehavior_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_msgs, srv, SetFullCollisionBehavior_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, franka_msgs, srv, SetFullCollisionBehavior_Event)),
  }
};
...
{
  return &::franka_msgs::srv::rosidl_typesupport_cpp::SetFullCollisionBehavior_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, franka_msgs, srv, SetFullCollisionBehavior_Event)() {
  return get_message_type_support_handle<franka_msgs::srv::SetFullCollisionBehavior_Event>();
}
...
static const rosidl_service_type_support_t SetFullCollisionBehavior_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<franka_msgs::srv::SetFullCollisionBehavior_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<franka_msgs::srv::SetFullCollisionBehavior_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<franka_msgs::srv::SetFullCollisionBehavior_Event>(),
