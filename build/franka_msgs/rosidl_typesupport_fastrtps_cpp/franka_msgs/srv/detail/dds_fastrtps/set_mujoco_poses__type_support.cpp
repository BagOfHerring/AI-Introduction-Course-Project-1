...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_franka_msgs
max_serialized_size_key_SetMujocoPoses_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_franka_msgs
max_serialized_size_key_SetMujocoPoses_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for franka_msgs::srv::SetMujocoPoses_Request already declared above

// functions for franka_msgs::srv::SetMujocoPoses_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_franka_msgs
cdr_serialize(
  const franka_msgs::srv::SetMujocoPoses_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  franka_msgs::srv::SetMujocoPoses_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_franka_msgs
max_serialized_size_SetMujocoPoses_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        franka_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetMujocoPoses_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        franka_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetMujocoPoses_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = franka_msgs::srv::SetMujocoPoses_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_franka_msgs
max_serialized_size_key_SetMujocoPoses_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        franka_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetMujocoPoses_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        franka_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetMujocoPoses_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const franka_msgs::srv::SetMujocoPoses_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<franka_msgs::srv::SetMujocoPoses_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetMujocoPoses_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const franka_msgs::srv::SetMujocoPoses_Event *>(
...
static size_t _SetMujocoPoses_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetMujocoPoses_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetMujocoPoses_Event__callbacks = {
  "franka_msgs::srv",
...
static rosidl_message_type_support_t _SetMujocoPoses_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetMujocoPoses_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &franka_msgs::srv::typesupport_fastrtps_cpp::_SetMujocoPoses_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_msgs, srv, SetMujocoPoses_Event)() {
  return &franka_msgs::srv::typesupport_fastrtps_cpp::_SetMujocoPoses_Event__handle;
}
...
static const rosidl_service_type_support_t _SetMujocoPoses__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetMujocoPoses__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<franka_msgs::srv::SetMujocoPoses_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<franka_msgs::srv::SetMujocoPoses_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<franka_msgs::srv::SetMujocoPoses_Event>(),
