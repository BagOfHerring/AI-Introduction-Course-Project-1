...
class Metaclass_SetTCPFrame_Event(type):
    """Metaclass of message 'SetTCPFrame_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_tcp_frame__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_tcp_frame__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_tcp_frame__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_tcp_frame__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_tcp_frame__event
...
class SetTCPFrame_Event(metaclass=Metaclass_SetTCPFrame_Event):
    """Message class 'SetTCPFrame_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<franka_msgs/SetTCPFrame_Request, 1>',
        'response': 'sequence<franka_msgs/SetTCPFrame_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['franka_msgs', 'srv'], 'SetTCPFrame_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['franka_msgs', 'srv'], 'SetTCPFrame_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from franka_msgs.srv import SetTCPFrame_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetTCPFrame_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetTCPFrame_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from franka_msgs.srv import SetTCPFrame_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetTCPFrame_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetTCPFrame_Response'"
...
class Metaclass_SetTCPFrame(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_tcp_frame.Metaclass_SetTCPFrame_Event._TYPE_SUPPORT is None:
                _set_tcp_frame.Metaclass_SetTCPFrame_Event.__import_type_support__()
...
class SetTCPFrame(metaclass=Metaclass_SetTCPFrame):
    ...
    from franka_msgs.srv._set_tcp_frame import SetTCPFrame_Event as Event
