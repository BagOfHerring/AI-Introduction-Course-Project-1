...
class SetCartesianStiffness_Request(metaclass=Metaclass_SetCartesianStiffness_Request):
    ...
    def __init__(self, **kwargs):
        ...
        if 'cartesian_stiffness' not in kwargs:
            ...
            self.cartesian_stiffness = kwargs.get('cartesian_stiffness')
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if any(self.cartesian_stiffness != other.cartesian_stiffness):
            return False
        return True
...
class Metaclass_SetCartesianStiffness_Event(type):
    """Metaclass of message 'SetCartesianStiffness_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_cartesian_stiffness__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_cartesian_stiffness__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_cartesian_stiffness__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_cartesian_stiffness__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_cartesian_stiffness__event
...
class SetCartesianStiffness_Event(metaclass=Metaclass_SetCartesianStiffness_Event):
    """Message class 'SetCartesianStiffness_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<franka_msgs/SetCartesianStiffness_Request, 1>',
        'response': 'sequence<franka_msgs/SetCartesianStiffness_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['franka_msgs', 'srv'], 'SetCartesianStiffness_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['franka_msgs', 'srv'], 'SetCartesianStiffness_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from franka_msgs.srv import SetCartesianStiffness_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetCartesianStiffness_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetCartesianStiffness_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from franka_msgs.srv import SetCartesianStiffness_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetCartesianStiffness_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetCartesianStiffness_Response'"
...
class Metaclass_SetCartesianStiffness(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_cartesian_stiffness.Metaclass_SetCartesianStiffness_Event._TYPE_SUPPORT is None:
                _set_cartesian_stiffness.Metaclass_SetCartesianStiffness_Event.__import_type_support__()
...
class SetCartesianStiffness(metaclass=Metaclass_SetCartesianStiffness):
    ...
    from franka_msgs.srv._set_cartesian_stiffness import SetCartesianStiffness_Event as Event
