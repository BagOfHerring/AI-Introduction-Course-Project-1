...
static const _SetMujocoPoses_Event_type_support_symbol_names_t _SetMujocoPoses_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_msgs, srv, SetMujocoPoses_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, franka_msgs, srv, SetMujocoPoses_Event)() {
  return &::franka_msgs::srv::rosidl_typesupport_c::SetMujocoPoses_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetMujocoPoses_service_type_support_handle = {
  ...
  &SetMujocoPoses_Request_message_type_support_handle,
  &SetMujocoPoses_Response_message_type_support_handle,
  &SetMujocoPoses_Event_message_type_support_handle,
