...
enum
{
  franka_msgs__srv__SetJointStiffness_Event__request__MAX_SIZE = 1
};
// response
enum
{
  franka_msgs__srv__SetJointStiffness_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetJointStiffness in the package franka_msgs.
typedef struct franka_msgs__srv__SetJointStiffness_Event
{
  service_msgs__msg__ServiceEventInfo info;
  franka_msgs__srv__SetJointStiffness_Request__Sequence request;
  franka_msgs__srv__SetJointStiffness_Response__Sequence response;
} franka_msgs__srv__SetJointStiffness_Event;

// Struct for a sequence of franka_msgs__srv__SetJointStiffness_Event.
typedef struct franka_msgs__srv__SetJointStiffness_Event__Sequence
{
