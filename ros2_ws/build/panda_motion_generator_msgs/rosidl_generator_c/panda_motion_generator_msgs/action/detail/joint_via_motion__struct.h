...
enum
{
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/JointViaMotion in the package panda_motion_generator_msgs.
typedef struct panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Request__Sequence request;
  panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Response__Sequence response;
} panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event;

// Struct for a sequence of panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event.
typedef struct panda_motion_generator_msgs__action__JointViaMotion_SendGoal_Event__Sequence
{
...
enum
{
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/JointViaMotion in the package panda_motion_generator_msgs.
typedef struct panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Request__Sequence request;
  panda_motion_generator_msgs__action__JointViaMotion_GetResult_Response__Sequence response;
} panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event;

// Struct for a sequence of panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event.
typedef struct panda_motion_generator_msgs__action__JointViaMotion_GetResult_Event__Sequence
{
