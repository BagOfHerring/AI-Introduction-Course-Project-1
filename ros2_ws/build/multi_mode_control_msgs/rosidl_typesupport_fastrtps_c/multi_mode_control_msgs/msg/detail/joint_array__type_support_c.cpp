...
#include "multi_mode_control_msgs/msg/detail/joint_array__rosidl_typesupport_fastrtps_c.h"
...
using _JointArray__ros_msg_type = multi_mode_control_msgs__msg__JointArray;
...
{
  const _JointArray__ros_msg_type * ros_message = static_cast<const _JointArray__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_mode_control_msgs__msg__JointArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const multi_mode_control_msgs__msg__JointArray * ros_message = static_cast<const multi_mode_control_msgs__msg__JointArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_multi_mode_control_msgs__msg__JointArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  multi_mode_control_msgs__msg__JointArray * ros_message = static_cast<multi_mode_control_msgs__msg__JointArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_multi_mode_control_msgs__msg__JointArray(cdr, ros_message);
}

static uint32_t _JointArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_multi_mode_control_msgs__msg__JointArray(
...
static size_t _JointArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_multi_mode_control_msgs__msg__JointArray(
...
static message_type_support_callbacks_t __callbacks_JointArray = {
...
static rosidl_message_type_support_t _JointArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointArray,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_mode_control_msgs, msg, JointArray)() {
  return &_JointArray__type_support;
}
