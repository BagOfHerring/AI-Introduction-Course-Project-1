...
#include "multi_mode_control_msgs/msg/detail/controller__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // name, resources
#include "rosidl_runtime_c/string_functions.h"  // name, resources

// forward declare type support functions


using _Controller__ros_msg_type = multi_mode_control_msgs__msg__Controller;
  ...
  multi_mode_control_msgs__msg__Controller * ros_message)
{
  ...
  // Field name: resources
  {
    ...
    if (ros_message->resources.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->resources);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->resources, size)) {
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'resources'\n");
        return false;
      }
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = multi_mode_control_msgs__msg__Controller;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const multi_mode_control_msgs__msg__Controller * ros_message = static_cast<const multi_mode_control_msgs__msg__Controller *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_multi_mode_control_msgs__msg__Controller(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  multi_mode_control_msgs__msg__Controller * ros_message = static_cast<multi_mode_control_msgs__msg__Controller *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_multi_mode_control_msgs__msg__Controller(cdr, ros_message);
}

static uint32_t _Controller__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_multi_mode_control_msgs__msg__Controller(
...
static size_t _Controller__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_multi_mode_control_msgs__msg__Controller(
