...
class Metaclass_SetRecoveryMode_Event(type):
    """Metaclass of message 'SetRecoveryMode_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_recovery_mode__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_recovery_mode__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_recovery_mode__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_recovery_mode__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_recovery_mode__event
...
class SetRecoveryMode_Event(metaclass=Metaclass_SetRecoveryMode_Event):
    """Message class 'SetRecoveryMode_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<multi_mode_control_msgs/SetRecoveryMode_Request, 1>',
        'response': 'sequence<multi_mode_control_msgs/SetRecoveryMode_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['multi_mode_control_msgs', 'srv'], 'SetRecoveryMode_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['multi_mode_control_msgs', 'srv'], 'SetRecoveryMode_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from multi_mode_control_msgs.srv import SetRecoveryMode_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetRecoveryMode_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetRecoveryMode_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from multi_mode_control_msgs.srv import SetRecoveryMode_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetRecoveryMode_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetRecoveryMode_Response'"
...
class Metaclass_SetRecoveryMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_recovery_mode.Metaclass_SetRecoveryMode_Event._TYPE_SUPPORT is None:
                _set_recovery_mode.Metaclass_SetRecoveryMode_Event.__import_type_support__()
...
class SetRecoveryMode(metaclass=Metaclass_SetRecoveryMode):
    ...
    from multi_mode_control_msgs.srv._set_recovery_mode import SetRecoveryMode_Event as Event
