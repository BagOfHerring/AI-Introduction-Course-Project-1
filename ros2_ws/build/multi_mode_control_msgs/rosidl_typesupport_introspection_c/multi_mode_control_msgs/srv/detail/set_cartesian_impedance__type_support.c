...
// Member `request`
// Member `response`
#include "multi_mode_control_msgs/srv/set_cartesian_impedance.h"
// Member `request`
// Member `response`
// already included above
// #include "multi_mode_control_msgs/srv/detail/set_cartesian_impedance__rosidl_typesupport_introspection_c.h"
...
void multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  multi_mode_control_msgs__srv__SetCartesianImpedance_Event__init(message_memory);
}

void multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_fini_function(void * message_memory)
{
  multi_mode_control_msgs__srv__SetCartesianImpedance_Event__fini(message_memory);
}

size_t multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__size_function__SetCartesianImpedance_Event__request(
  const void * untyped_member)
{
  const multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence * member =
    (const multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_const_function__SetCartesianImpedance_Event__request(
  const void * untyped_member, size_t index)
{
  const multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence * member =
    (const multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence *)(untyped_member);
...
void * multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_function__SetCartesianImpedance_Event__request(
  void * untyped_member, size_t index)
{
  multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence * member =
    (multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__fetch_function__SetCartesianImpedance_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const multi_mode_control_msgs__srv__SetCartesianImpedance_Request * item =
    ((const multi_mode_control_msgs__srv__SetCartesianImpedance_Request *)
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_const_function__SetCartesianImpedance_Event__request(untyped_member, index));
  multi_mode_control_msgs__srv__SetCartesianImpedance_Request * value =
    (multi_mode_control_msgs__srv__SetCartesianImpedance_Request *)(untyped_value);
  *value = *item;
}

void multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__assign_function__SetCartesianImpedance_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  multi_mode_control_msgs__srv__SetCartesianImpedance_Request * item =
    ((multi_mode_control_msgs__srv__SetCartesianImpedance_Request *)
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_function__SetCartesianImpedance_Event__request(untyped_member, index));
  const multi_mode_control_msgs__srv__SetCartesianImpedance_Request * value =
    (const multi_mode_control_msgs__srv__SetCartesianImpedance_Request *)(untyped_value);
  *item = *value;
}

bool multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__resize_function__SetCartesianImpedance_Event__request(
  void * untyped_member, size_t size)
{
  multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence * member =
    (multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence *)(untyped_member);
  multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence__fini(member);
  return multi_mode_control_msgs__srv__SetCartesianImpedance_Request__Sequence__init(member, size);
}

size_t multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__size_function__SetCartesianImpedance_Event__response(
  const void * untyped_member)
{
  const multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence * member =
    (const multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_const_function__SetCartesianImpedance_Event__response(
  const void * untyped_member, size_t index)
{
  const multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence * member =
    (const multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence *)(untyped_member);
...
void * multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_function__SetCartesianImpedance_Event__response(
  void * untyped_member, size_t index)
{
  multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence * member =
    (multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__fetch_function__SetCartesianImpedance_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const multi_mode_control_msgs__srv__SetCartesianImpedance_Response * item =
    ((const multi_mode_control_msgs__srv__SetCartesianImpedance_Response *)
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_const_function__SetCartesianImpedance_Event__response(untyped_member, index));
  multi_mode_control_msgs__srv__SetCartesianImpedance_Response * value =
    (multi_mode_control_msgs__srv__SetCartesianImpedance_Response *)(untyped_value);
  *value = *item;
}

void multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__assign_function__SetCartesianImpedance_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  multi_mode_control_msgs__srv__SetCartesianImpedance_Response * item =
    ((multi_mode_control_msgs__srv__SetCartesianImpedance_Response *)
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_function__SetCartesianImpedance_Event__response(untyped_member, index));
  const multi_mode_control_msgs__srv__SetCartesianImpedance_Response * value =
    (const multi_mode_control_msgs__srv__SetCartesianImpedance_Response *)(untyped_value);
  *item = *value;
}

bool multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__resize_function__SetCartesianImpedance_Event__response(
  void * untyped_member, size_t size)
{
  multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence * member =
    (multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence *)(untyped_member);
  multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence__fini(member);
  return multi_mode_control_msgs__srv__SetCartesianImpedance_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(multi_mode_control_msgs__srv__SetCartesianImpedance_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(multi_mode_control_msgs__srv__SetCartesianImpedance_Event, request),  // bytes offset in struct
    NULL,  // default value
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__size_function__SetCartesianImpedance_Event__request,  // size() function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_const_function__SetCartesianImpedance_Event__request,  // get_const(index) function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_function__SetCartesianImpedance_Event__request,  // get(index) function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__fetch_function__SetCartesianImpedance_Event__request,  // fetch(index, &value) function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__assign_function__SetCartesianImpedance_Event__request,  // assign(index, value) function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__resize_function__SetCartesianImpedance_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(multi_mode_control_msgs__srv__SetCartesianImpedance_Event, response),  // bytes offset in struct
    NULL,  // default value
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__size_function__SetCartesianImpedance_Event__response,  // size() function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_const_function__SetCartesianImpedance_Event__response,  // get_const(index) function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__get_function__SetCartesianImpedance_Event__response,  // get(index) function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__fetch_function__SetCartesianImpedance_Event__response,  // fetch(index, &value) function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__assign_function__SetCartesianImpedance_Event__response,  // assign(index, value) function pointer
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__resize_function__SetCartesianImpedance_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_members = {
  "multi_mode_control_msgs__srv",  // message namespace
  "SetCartesianImpedance_Event",  // message name
  3,  // number of fields
  sizeof(multi_mode_control_msgs__srv__SetCartesianImpedance_Event),
  false,  // has_any_key_member_
  multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_member_array,  // message members
  multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_type_support_handle = {
  0,
  &multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_multi_mode_control_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, SetCartesianImpedance_Event)() {
  multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, SetCartesianImpedance_Request)();
  multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, SetCartesianImpedance_Response)();
  if (!multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_type_support_handle.typesupport_identifier) {
    multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t multi_mode_control_msgs__srv__detail__set_cartesian_impedance__rosidl_typesupport_introspection_c__SetCartesianImpedance_service_type_support_handle = {
  ...
  &multi_mode_control_msgs__srv__SetCartesianImpedance_Request__rosidl_typesupport_introspection_c__SetCartesianImpedance_Request_message_type_support_handle,
  &multi_mode_control_msgs__srv__SetCartesianImpedance_Response__rosidl_typesupport_introspection_c__SetCartesianImpedance_Response_message_type_support_handle,
  &multi_mode_control_msgs__srv__SetCartesianImpedance_Event__rosidl_typesupport_introspection_c__SetCartesianImpedance_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, SetCartesianImpedance_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, SetCartesianImpedance_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, SetCartesianImpedance_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_multi_mode_control_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, SetCartesianImpedance)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, SetCartesianImpedance_Event)()->data;
  }
