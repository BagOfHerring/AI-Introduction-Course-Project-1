...
inline std::string to_yaml(const SetWorldState_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use multi_mode_control_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const multi_mode_control_msgs::srv::SetWorldState_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  multi_mode_control_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use multi_mode_control_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const multi_mode_control_msgs::srv::SetWorldState_Event & msg)
{
  return multi_mode_control_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<multi_mode_control_msgs::srv::SetWorldState_Event>()
{
  return "multi_mode_control_msgs::srv::SetWorldState_Event";
}

template<>
inline const char * name<multi_mode_control_msgs::srv::SetWorldState_Event>()
{
  return "multi_mode_control_msgs/srv/SetWorldState_Event";
}

template<>
struct has_fixed_size<multi_mode_control_msgs::srv::SetWorldState_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<multi_mode_control_msgs::srv::SetWorldState_Event>
  : std::integral_constant<bool, has_bounded_size<multi_mode_control_msgs::srv::SetWorldState_Request>::value && has_bounded_size<multi_mode_control_msgs::srv::SetWorldState_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<multi_mode_control_msgs::srv::SetWorldState_Event>
  : std::true_type {};
