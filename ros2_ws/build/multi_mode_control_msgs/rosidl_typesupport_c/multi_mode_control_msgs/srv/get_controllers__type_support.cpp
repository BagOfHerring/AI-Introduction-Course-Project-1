...
static const _GetControllers_Event_type_support_symbol_names_t _GetControllers_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_mode_control_msgs, srv, GetControllers_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, GetControllers_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, multi_mode_control_msgs, srv, GetControllers_Event)() {
  return &::multi_mode_control_msgs::srv::rosidl_typesupport_c::GetControllers_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetControllers_service_type_support_handle = {
  ...
  &GetControllers_Request_message_type_support_handle,
  &GetControllers_Response_message_type_support_handle,
  &GetControllers_Event_message_type_support_handle,
