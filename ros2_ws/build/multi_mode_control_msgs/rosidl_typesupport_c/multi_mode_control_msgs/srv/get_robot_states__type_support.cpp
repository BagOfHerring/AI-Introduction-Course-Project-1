...
static const _GetRobotStates_Event_type_support_symbol_names_t _GetRobotStates_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, multi_mode_control_msgs, srv, GetRobotStates_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multi_mode_control_msgs, srv, GetRobotStates_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, multi_mode_control_msgs, srv, GetRobotStates_Event)() {
  return &::multi_mode_control_msgs::srv::rosidl_typesupport_c::GetRobotStates_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetRobotStates_service_type_support_handle = {
  ...
  &GetRobotStates_Request_message_type_support_handle,
  &GetRobotStates_Response_message_type_support_handle,
  &GetRobotStates_Event_message_type_support_handle,
