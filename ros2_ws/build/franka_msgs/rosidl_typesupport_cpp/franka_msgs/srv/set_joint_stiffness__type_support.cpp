...
static const _SetJointStiffness_Event_type_support_symbol_names_t _SetJointStiffness_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, franka_msgs, srv, SetJointStiffness_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, franka_msgs, srv, SetJointStiffness_Event)),
  }
};
...
{
  return &::franka_msgs::srv::rosidl_typesupport_cpp::SetJointStiffness_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, franka_msgs, srv, SetJointStiffness_Event)() {
  return get_message_type_support_handle<franka_msgs::srv::SetJointStiffness_Event>();
}
...
static const rosidl_service_type_support_t SetJointStiffness_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<franka_msgs::srv::SetJointStiffness_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<franka_msgs::srv::SetJointStiffness_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<franka_msgs::srv::SetJointStiffness_Event>(),
