...
void franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  franka_msgs__srv__SetMujocoPoses_Event__init(message_memory);
}

void franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_fini_function(void * message_memory)
{
  franka_msgs__srv__SetMujocoPoses_Event__fini(message_memory);
}

size_t franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__size_function__SetMujocoPoses_Event__request(
  const void * untyped_member)
{
  const franka_msgs__srv__SetMujocoPoses_Request__Sequence * member =
    (const franka_msgs__srv__SetMujocoPoses_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_const_function__SetMujocoPoses_Event__request(
  const void * untyped_member, size_t index)
{
  const franka_msgs__srv__SetMujocoPoses_Request__Sequence * member =
    (const franka_msgs__srv__SetMujocoPoses_Request__Sequence *)(untyped_member);
...
void * franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_function__SetMujocoPoses_Event__request(
  void * untyped_member, size_t index)
{
  franka_msgs__srv__SetMujocoPoses_Request__Sequence * member =
    (franka_msgs__srv__SetMujocoPoses_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__fetch_function__SetMujocoPoses_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const franka_msgs__srv__SetMujocoPoses_Request * item =
    ((const franka_msgs__srv__SetMujocoPoses_Request *)
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_const_function__SetMujocoPoses_Event__request(untyped_member, index));
  franka_msgs__srv__SetMujocoPoses_Request * value =
    (franka_msgs__srv__SetMujocoPoses_Request *)(untyped_value);
  *value = *item;
}

void franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__assign_function__SetMujocoPoses_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  franka_msgs__srv__SetMujocoPoses_Request * item =
    ((franka_msgs__srv__SetMujocoPoses_Request *)
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_function__SetMujocoPoses_Event__request(untyped_member, index));
  const franka_msgs__srv__SetMujocoPoses_Request * value =
    (const franka_msgs__srv__SetMujocoPoses_Request *)(untyped_value);
  *item = *value;
}

bool franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__resize_function__SetMujocoPoses_Event__request(
  void * untyped_member, size_t size)
{
  franka_msgs__srv__SetMujocoPoses_Request__Sequence * member =
    (franka_msgs__srv__SetMujocoPoses_Request__Sequence *)(untyped_member);
  franka_msgs__srv__SetMujocoPoses_Request__Sequence__fini(member);
  return franka_msgs__srv__SetMujocoPoses_Request__Sequence__init(member, size);
}

size_t franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__size_function__SetMujocoPoses_Event__response(
  const void * untyped_member)
{
  const franka_msgs__srv__SetMujocoPoses_Response__Sequence * member =
    (const franka_msgs__srv__SetMujocoPoses_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_const_function__SetMujocoPoses_Event__response(
  const void * untyped_member, size_t index)
{
  const franka_msgs__srv__SetMujocoPoses_Response__Sequence * member =
    (const franka_msgs__srv__SetMujocoPoses_Response__Sequence *)(untyped_member);
...
void * franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_function__SetMujocoPoses_Event__response(
  void * untyped_member, size_t index)
{
  franka_msgs__srv__SetMujocoPoses_Response__Sequence * member =
    (franka_msgs__srv__SetMujocoPoses_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__fetch_function__SetMujocoPoses_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const franka_msgs__srv__SetMujocoPoses_Response * item =
    ((const franka_msgs__srv__SetMujocoPoses_Response *)
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_const_function__SetMujocoPoses_Event__response(untyped_member, index));
  franka_msgs__srv__SetMujocoPoses_Response * value =
    (franka_msgs__srv__SetMujocoPoses_Response *)(untyped_value);
  *value = *item;
}

void franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__assign_function__SetMujocoPoses_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  franka_msgs__srv__SetMujocoPoses_Response * item =
    ((franka_msgs__srv__SetMujocoPoses_Response *)
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_function__SetMujocoPoses_Event__response(untyped_member, index));
  const franka_msgs__srv__SetMujocoPoses_Response * value =
    (const franka_msgs__srv__SetMujocoPoses_Response *)(untyped_value);
  *item = *value;
}

bool franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__resize_function__SetMujocoPoses_Event__response(
  void * untyped_member, size_t size)
{
  franka_msgs__srv__SetMujocoPoses_Response__Sequence * member =
    (franka_msgs__srv__SetMujocoPoses_Response__Sequence *)(untyped_member);
  franka_msgs__srv__SetMujocoPoses_Response__Sequence__fini(member);
  return franka_msgs__srv__SetMujocoPoses_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(franka_msgs__srv__SetMujocoPoses_Event, info),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(franka_msgs__srv__SetMujocoPoses_Event, request),  // bytes offset in struct
    NULL,  // default value
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__size_function__SetMujocoPoses_Event__request,  // size() function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_const_function__SetMujocoPoses_Event__request,  // get_const(index) function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_function__SetMujocoPoses_Event__request,  // get(index) function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__fetch_function__SetMujocoPoses_Event__request,  // fetch(index, &value) function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__assign_function__SetMujocoPoses_Event__request,  // assign(index, value) function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__resize_function__SetMujocoPoses_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(franka_msgs__srv__SetMujocoPoses_Event, response),  // bytes offset in struct
    NULL,  // default value
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__size_function__SetMujocoPoses_Event__response,  // size() function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_const_function__SetMujocoPoses_Event__response,  // get_const(index) function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__get_function__SetMujocoPoses_Event__response,  // get(index) function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__fetch_function__SetMujocoPoses_Event__response,  // fetch(index, &value) function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__assign_function__SetMujocoPoses_Event__response,  // assign(index, value) function pointer
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__resize_function__SetMujocoPoses_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_members = {
  "franka_msgs__srv",  // message namespace
  "SetMujocoPoses_Event",  // message name
  3,  // number of fields
  sizeof(franka_msgs__srv__SetMujocoPoses_Event),
  false,  // has_any_key_member_
  franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_member_array,  // message members
  franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_type_support_handle = {
  0,
  &franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_franka_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses_Event)() {
  franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses_Request)();
  franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses_Response)();
  if (!franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_type_support_handle.typesupport_identifier) {
    franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t franka_msgs__srv__detail__set_mujoco_poses__rosidl_typesupport_introspection_c__SetMujocoPoses_service_type_support_handle = {
  ...
  &franka_msgs__srv__SetMujocoPoses_Request__rosidl_typesupport_introspection_c__SetMujocoPoses_Request_message_type_support_handle,
  &franka_msgs__srv__SetMujocoPoses_Response__rosidl_typesupport_introspection_c__SetMujocoPoses_Response_message_type_support_handle,
  &franka_msgs__srv__SetMujocoPoses_Event__rosidl_typesupport_introspection_c__SetMujocoPoses_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_franka_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, srv, SetMujocoPoses_Event)()->data;
  }
