...
class SetFullCollisionBehavior_Request(metaclass=Metaclass_SetFullCollisionBehavior_Request):
    ...
    def __init__(self, **kwargs):
        ...
        if 'lower_torque_thresholds_acceleration' not in kwargs:
            ...
            self.lower_torque_thresholds_acceleration = kwargs.get('lower_torque_thresholds_acceleration')
        if 'upper_torque_thresholds_acceleration' not in kwargs:
            ...
            self.upper_torque_thresholds_acceleration = kwargs.get('upper_torque_thresholds_acceleration')
        ...
        if 'lower_force_thresholds_acceleration' not in kwargs:
            ...
            self.lower_force_thresholds_acceleration = kwargs.get('lower_force_thresholds_acceleration')
        if 'upper_force_thresholds_acceleration' not in kwargs:
            ...
            self.upper_force_thresholds_acceleration = kwargs.get('upper_force_thresholds_acceleration')
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if any(self.lower_torque_thresholds_acceleration != other.lower_torque_thresholds_acceleration):
            return False
        if any(self.upper_torque_thresholds_acceleration != other.upper_torque_thresholds_acceleration):
            return False
        ...
        if any(self.upper_torque_thresholds_nominal != other.upper_torque_thresholds_nominal):
            return False
        if any(self.lower_force_thresholds_acceleration != other.lower_force_thresholds_acceleration):
            return False
        if any(self.upper_force_thresholds_acceleration != other.upper_force_thresholds_acceleration):
            return False
...
class Metaclass_SetFullCollisionBehavior_Event(type):
    """Metaclass of message 'SetFullCollisionBehavior_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_full_collision_behavior__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_full_collision_behavior__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_full_collision_behavior__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_full_collision_behavior__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_full_collision_behavior__event
...
class SetFullCollisionBehavior_Event(metaclass=Metaclass_SetFullCollisionBehavior_Event):
    """Message class 'SetFullCollisionBehavior_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<franka_msgs/SetFullCollisionBehavior_Request, 1>',
        'response': 'sequence<franka_msgs/SetFullCollisionBehavior_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['franka_msgs', 'srv'], 'SetFullCollisionBehavior_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['franka_msgs', 'srv'], 'SetFullCollisionBehavior_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from franka_msgs.srv import SetFullCollisionBehavior_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetFullCollisionBehavior_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetFullCollisionBehavior_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from franka_msgs.srv import SetFullCollisionBehavior_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetFullCollisionBehavior_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetFullCollisionBehavior_Response'"
...
class Metaclass_SetFullCollisionBehavior(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_full_collision_behavior.Metaclass_SetFullCollisionBehavior_Event._TYPE_SUPPORT is None:
                _set_full_collision_behavior.Metaclass_SetFullCollisionBehavior_Event.__import_type_support__()
...
class SetFullCollisionBehavior(metaclass=Metaclass_SetFullCollisionBehavior):
    ...
    from franka_msgs.srv._set_full_collision_behavior import SetFullCollisionBehavior_Event as Event
