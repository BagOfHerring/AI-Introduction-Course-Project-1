...
static const _Homing_SendGoal_Event_type_support_symbol_names_t _Homing_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_msgs, action, Homing_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, action, Homing_SendGoal_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, franka_msgs, action, Homing_SendGoal_Event)() {
  return &::franka_msgs::action::rosidl_typesupport_c::Homing_SendGoal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Homing_SendGoal_service_type_support_handle = {
  ...
  &Homing_SendGoal_Request_message_type_support_handle,
  &Homing_SendGoal_Response_message_type_support_handle,
  &Homing_SendGoal_Event_message_type_support_handle,
...
static const _Homing_GetResult_Event_type_support_symbol_names_t _Homing_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, franka_msgs, action, Homing_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, franka_msgs, action, Homing_GetResult_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, franka_msgs, action, Homing_GetResult_Event)() {
  return &::franka_msgs::action::rosidl_typesupport_c::Homing_GetResult_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t Homing_GetResult_service_type_support_handle = {
  ...
  rosidl_typesupport_c__get_service_typesupport_handle_function,
  &Homing_GetResult_Request_message_type_support_handle,
  &Homing_GetResult_Response_message_type_support_handle,
  &Homing_GetResult_Event_message_type_support_handle,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    franka_msgs,
    action,
