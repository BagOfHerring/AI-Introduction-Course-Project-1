...
class Init_SetJointStiffness_Event_response
{
public:
  explicit Init_SetJointStiffness_Event_response(::franka_msgs::srv::SetJointStiffness_Event & msg)
  : msg_(msg)
  {}
  ::franka_msgs::srv::SetJointStiffness_Event response(::franka_msgs::srv::SetJointStiffness_Event::_response_type arg)
  {
...
private:
  ::franka_msgs::srv::SetJointStiffness_Event msg_;
};

class Init_SetJointStiffness_Event_request
{
public:
  explicit Init_SetJointStiffness_Event_request(::franka_msgs::srv::SetJointStiffness_Event & msg)
  : msg_(msg)
  {}
  Init_SetJointStiffness_Event_response request(::franka_msgs::srv::SetJointStiffness_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetJointStiffness_Event_response(msg_);
  }
...
class Init_SetJointStiffness_Event_info
{
public:
  Init_SetJointStiffness_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetJointStiffness_Event_request info(::franka_msgs::srv::SetJointStiffness_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetJointStiffness_Event_request(msg_);
  }
...
template<>
inline
auto build<::franka_msgs::srv::SetJointStiffness_Event>()
{
  return franka_msgs::srv::builder::Init_SetJointStiffness_Event_info();
}
