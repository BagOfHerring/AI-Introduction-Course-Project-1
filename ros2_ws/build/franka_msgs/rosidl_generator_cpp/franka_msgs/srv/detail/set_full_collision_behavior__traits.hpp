...
inline void to_flow_style_yaml(
  const SetFullCollisionBehavior_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const SetFullCollisionBehavior_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use franka_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const franka_msgs::srv::SetFullCollisionBehavior_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  franka_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use franka_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const franka_msgs::srv::SetFullCollisionBehavior_Event & msg)
{
  return franka_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<franka_msgs::srv::SetFullCollisionBehavior_Event>()
{
  return "franka_msgs::srv::SetFullCollisionBehavior_Event";
}

template<>
inline const char * name<franka_msgs::srv::SetFullCollisionBehavior_Event>()
{
  return "franka_msgs/srv/SetFullCollisionBehavior_Event";
}

template<>
struct has_fixed_size<franka_msgs::srv::SetFullCollisionBehavior_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<franka_msgs::srv::SetFullCollisionBehavior_Event>
  : std::integral_constant<bool, has_bounded_size<franka_msgs::srv::SetFullCollisionBehavior_Request>::value && has_bounded_size<franka_msgs::srv::SetFullCollisionBehavior_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<franka_msgs::srv::SetFullCollisionBehavior_Event>
  : std::true_type {};
