...
enum
{
  franka_msgs__action__Grasp_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  franka_msgs__action__Grasp_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Grasp in the package franka_msgs.
typedef struct franka_msgs__action__Grasp_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  franka_msgs__action__Grasp_SendGoal_Request__Sequence request;
  franka_msgs__action__Grasp_SendGoal_Response__Sequence response;
} franka_msgs__action__Grasp_SendGoal_Event;

// Struct for a sequence of franka_msgs__action__Grasp_SendGoal_Event.
typedef struct franka_msgs__action__Grasp_SendGoal_Event__Sequence
{
...
enum
{
  franka_msgs__action__Grasp_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  franka_msgs__action__Grasp_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Grasp in the package franka_msgs.
typedef struct franka_msgs__action__Grasp_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  franka_msgs__action__Grasp_GetResult_Request__Sequence request;
  franka_msgs__action__Grasp_GetResult_Response__Sequence response;
} franka_msgs__action__Grasp_GetResult_Event;

// Struct for a sequence of franka_msgs__action__Grasp_GetResult_Event.
typedef struct franka_msgs__action__Grasp_GetResult_Event__Sequence
{
