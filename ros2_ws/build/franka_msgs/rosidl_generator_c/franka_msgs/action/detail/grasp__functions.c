...
franka_msgs__action__Grasp_SendGoal_Event__init(franka_msgs__action__Grasp_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    franka_msgs__action__Grasp_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!franka_msgs__action__Grasp_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    franka_msgs__action__Grasp_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!franka_msgs__action__Grasp_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    franka_msgs__action__Grasp_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
franka_msgs__action__Grasp_SendGoal_Event__fini(franka_msgs__action__Grasp_SendGoal_Event * msg)
{
  ...
  // request
  franka_msgs__action__Grasp_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  franka_msgs__action__Grasp_SendGoal_Response__Sequence__fini(&msg->response);
}
...
franka_msgs__action__Grasp_SendGoal_Event__are_equal(const franka_msgs__action__Grasp_SendGoal_Event * lhs, const franka_msgs__action__Grasp_SendGoal_Event * rhs)
{
  ...
  // request
  if (!franka_msgs__action__Grasp_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!franka_msgs__action__Grasp_SendGoal_Response__Sequence__are_equal(
  ...
  franka_msgs__action__Grasp_SendGoal_Event * output)
{
  ...
  // request
  if (!franka_msgs__action__Grasp_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!franka_msgs__action__Grasp_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franka_msgs__action__Grasp_SendGoal_Event * msg = (franka_msgs__action__Grasp_SendGoal_Event *)allocator.allocate(sizeof(franka_msgs__action__Grasp_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(franka_msgs__action__Grasp_SendGoal_Event));
  bool success = franka_msgs__action__Grasp_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
franka_msgs__action__Grasp_SendGoal_Event__Sequence__init(franka_msgs__action__Grasp_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franka_msgs__action__Grasp_SendGoal_Event * data = NULL;

  if (size) {
    data = (franka_msgs__action__Grasp_SendGoal_Event *)allocator.zero_allocate(size, sizeof(franka_msgs__action__Grasp_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = franka_msgs__action__Grasp_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        franka_msgs__action__Grasp_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
franka_msgs__action__Grasp_SendGoal_Event__Sequence__fini(franka_msgs__action__Grasp_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      franka_msgs__action__Grasp_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franka_msgs__action__Grasp_SendGoal_Event__Sequence * array = (franka_msgs__action__Grasp_SendGoal_Event__Sequence *)allocator.allocate(sizeof(franka_msgs__action__Grasp_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = franka_msgs__action__Grasp_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
franka_msgs__action__Grasp_SendGoal_Event__Sequence__destroy(franka_msgs__action__Grasp_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    franka_msgs__action__Grasp_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
franka_msgs__action__Grasp_SendGoal_Event__Sequence__are_equal(const franka_msgs__action__Grasp_SendGoal_Event__Sequence * lhs, const franka_msgs__action__Grasp_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!franka_msgs__action__Grasp_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  franka_msgs__action__Grasp_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(franka_msgs__action__Grasp_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    franka_msgs__action__Grasp_SendGoal_Event * data =
      (franka_msgs__action__Grasp_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!franka_msgs__action__Grasp_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
franka_msgs__action__Grasp_GetResult_Event__init(franka_msgs__action__Grasp_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    franka_msgs__action__Grasp_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!franka_msgs__action__Grasp_GetResult_Request__Sequence__init(&msg->request, 0)) {
    franka_msgs__action__Grasp_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!franka_msgs__action__Grasp_GetResult_Response__Sequence__init(&msg->response, 0)) {
    franka_msgs__action__Grasp_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
franka_msgs__action__Grasp_GetResult_Event__fini(franka_msgs__action__Grasp_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  franka_msgs__action__Grasp_GetResult_Request__Sequence__fini(&msg->request);
  // response
  franka_msgs__action__Grasp_GetResult_Response__Sequence__fini(&msg->response);
}
...
franka_msgs__action__Grasp_GetResult_Event__are_equal(const franka_msgs__action__Grasp_GetResult_Event * lhs, const franka_msgs__action__Grasp_GetResult_Event * rhs)
{
  ...
  // request
  if (!franka_msgs__action__Grasp_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!franka_msgs__action__Grasp_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  franka_msgs__action__Grasp_GetResult_Event * output)
{
  ...
  // request
  if (!franka_msgs__action__Grasp_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!franka_msgs__action__Grasp_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franka_msgs__action__Grasp_GetResult_Event * msg = (franka_msgs__action__Grasp_GetResult_Event *)allocator.allocate(sizeof(franka_msgs__action__Grasp_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(franka_msgs__action__Grasp_GetResult_Event));
  bool success = franka_msgs__action__Grasp_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
franka_msgs__action__Grasp_GetResult_Event__Sequence__init(franka_msgs__action__Grasp_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franka_msgs__action__Grasp_GetResult_Event * data = NULL;

  if (size) {
    data = (franka_msgs__action__Grasp_GetResult_Event *)allocator.zero_allocate(size, sizeof(franka_msgs__action__Grasp_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = franka_msgs__action__Grasp_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        franka_msgs__action__Grasp_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
franka_msgs__action__Grasp_GetResult_Event__Sequence__fini(franka_msgs__action__Grasp_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      franka_msgs__action__Grasp_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  franka_msgs__action__Grasp_GetResult_Event__Sequence * array = (franka_msgs__action__Grasp_GetResult_Event__Sequence *)allocator.allocate(sizeof(franka_msgs__action__Grasp_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = franka_msgs__action__Grasp_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
franka_msgs__action__Grasp_GetResult_Event__Sequence__destroy(franka_msgs__action__Grasp_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    franka_msgs__action__Grasp_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
franka_msgs__action__Grasp_GetResult_Event__Sequence__are_equal(const franka_msgs__action__Grasp_GetResult_Event__Sequence * lhs, const franka_msgs__action__Grasp_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!franka_msgs__action__Grasp_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  franka_msgs__action__Grasp_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(franka_msgs__action__Grasp_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    franka_msgs__action__Grasp_GetResult_Event * data =
      (franka_msgs__action__Grasp_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!franka_msgs__action__Grasp_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
