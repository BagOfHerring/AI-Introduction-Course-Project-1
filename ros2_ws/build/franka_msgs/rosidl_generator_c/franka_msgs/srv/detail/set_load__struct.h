...
enum
{
  franka_msgs__srv__SetLoad_Event__request__MAX_SIZE = 1
};
// response
enum
{
  franka_msgs__srv__SetLoad_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetLoad in the package franka_msgs.
typedef struct franka_msgs__srv__SetLoad_Event
{
  service_msgs__msg__ServiceEventInfo info;
  franka_msgs__srv__SetLoad_Request__Sequence request;
  franka_msgs__srv__SetLoad_Response__Sequence response;
} franka_msgs__srv__SetLoad_Event;

// Struct for a sequence of franka_msgs__srv__SetLoad_Event.
typedef struct franka_msgs__srv__SetLoad_Event__Sequence
{
