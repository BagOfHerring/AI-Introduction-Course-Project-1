...
enum
{
  franka_msgs__srv__ErrorRecovery_Event__request__MAX_SIZE = 1
};
// response
enum
{
  franka_msgs__srv__ErrorRecovery_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ErrorRecovery in the package franka_msgs.
typedef struct franka_msgs__srv__ErrorRecovery_Event
{
  service_msgs__msg__ServiceEventInfo info;
  franka_msgs__srv__ErrorRecovery_Request__Sequence request;
  franka_msgs__srv__ErrorRecovery_Response__Sequence response;
} franka_msgs__srv__ErrorRecovery_Event;

// Struct for a sequence of franka_msgs__srv__ErrorRecovery_Event.
typedef struct franka_msgs__srv__ErrorRecovery_Event__Sequence
{
