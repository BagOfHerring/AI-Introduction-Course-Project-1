...
static const _GetGeomProperties_Event_type_support_symbol_names_t _GetGeomProperties_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mujoco_ros_msgs, srv, GetGeomProperties_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mujoco_ros_msgs, srv, GetGeomProperties_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mujoco_ros_msgs, srv, GetGeomProperties_Event)() {
  return &::mujoco_ros_msgs::srv::rosidl_typesupport_c::GetGeomProperties_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t GetGeomProperties_service_type_support_handle = {
  ...
  &GetGeomProperties_Request_message_type_support_handle,
  &GetGeomProperties_Response_message_type_support_handle,
  &GetGeomProperties_Event_message_type_support_handle,
