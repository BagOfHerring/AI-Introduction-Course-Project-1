...
class Init_SetBodyState_Event_response
{
public:
  explicit Init_SetBodyState_Event_response(::mujoco_ros_msgs::srv::SetBodyState_Event & msg)
  : msg_(msg)
  {}
  ::mujoco_ros_msgs::srv::SetBodyState_Event response(::mujoco_ros_msgs::srv::SetBodyState_Event::_response_type arg)
  {
...
private:
  ::mujoco_ros_msgs::srv::SetBodyState_Event msg_;
};

class Init_SetBodyState_Event_request
{
public:
  explicit Init_SetBodyState_Event_request(::mujoco_ros_msgs::srv::SetBodyState_Event & msg)
  : msg_(msg)
  {}
  Init_SetBodyState_Event_response request(::mujoco_ros_msgs::srv::SetBodyState_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetBodyState_Event_response(msg_);
  }
...
class Init_SetBodyState_Event_info
{
public:
  Init_SetBodyState_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetBodyState_Event_request info(::mujoco_ros_msgs::srv::SetBodyState_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetBodyState_Event_request(msg_);
  }
...
template<>
inline
auto build<::mujoco_ros_msgs::srv::SetBodyState_Event>()
{
  return mujoco_ros_msgs::srv::builder::Init_SetBodyState_Event_info();
}
