...
inline std::string to_yaml(const GetStateUint_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use mujoco_ros_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const mujoco_ros_msgs::srv::GetStateUint_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  mujoco_ros_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use mujoco_ros_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const mujoco_ros_msgs::srv::GetStateUint_Event & msg)
{
  return mujoco_ros_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<mujoco_ros_msgs::srv::GetStateUint_Event>()
{
  return "mujoco_ros_msgs::srv::GetStateUint_Event";
}

template<>
inline const char * name<mujoco_ros_msgs::srv::GetStateUint_Event>()
{
  return "mujoco_ros_msgs/srv/GetStateUint_Event";
}

template<>
struct has_fixed_size<mujoco_ros_msgs::srv::GetStateUint_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<mujoco_ros_msgs::srv::GetStateUint_Event>
  : std::integral_constant<bool, has_bounded_size<mujoco_ros_msgs::srv::GetStateUint_Request>::value && has_bounded_size<mujoco_ros_msgs::srv::GetStateUint_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<mujoco_ros_msgs::srv::GetStateUint_Event>
  : std::true_type {};
