...
{
public:
  explicit Init_SetGravity_Event_response(::mujoco_ros_msgs::srv::SetGravity_Event & msg)
  : msg_(msg)
  {}
  ::mujoco_ros_msgs::srv::SetGravity_Event response(::mujoco_ros_msgs::srv::SetGravity_Event::_response_type arg)
  {
...
private:
  ::mujoco_ros_msgs::srv::SetGravity_Event msg_;
};

class Init_SetGravity_Event_request
{
public:
  explicit Init_SetGravity_Event_request(::mujoco_ros_msgs::srv::SetGravity_Event & msg)
  : msg_(msg)
  {}
  Init_SetGravity_Event_response request(::mujoco_ros_msgs::srv::SetGravity_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetGravity_Event_request info(::mujoco_ros_msgs::srv::SetGravity_Event::_info_type arg)
  {
...
template<>
inline
auto build<::mujoco_ros_msgs::srv::SetGravity_Event>()
{
  return mujoco_ros_msgs::srv::builder::Init_SetGravity_Event_info();
}
