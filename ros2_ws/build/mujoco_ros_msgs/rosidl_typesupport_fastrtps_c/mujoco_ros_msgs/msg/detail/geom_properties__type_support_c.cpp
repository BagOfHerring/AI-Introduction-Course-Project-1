  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: type
  {
    cdr_serialize_mujoco_ros_msgs__msg__GeomType(
  ...
  mujoco_ros_msgs__msg__GeomProperties * ros_message)
{
  ...
  // Field name: type
  {
    cdr_deserialize_mujoco_ros_msgs__msg__GeomType(cdr, &ros_message->type);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: type
  {
    cdr_serialize_key_mujoco_ros_msgs__msg__GeomType(
      &ros_message->type, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: type
  current_alignment += get_serialized_size_key_mujoco_ros_msgs__msg__GeomType(
    &(ros_message->type), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: type
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mujoco_ros_msgs__msg__GeomType(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mujoco_ros_msgs__msg__GeomProperties * ros_message = static_cast<const mujoco_ros_msgs__msg__GeomProperties *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mujoco_ros_msgs__msg__GeomProperties(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mujoco_ros_msgs__msg__GeomProperties * ros_message = static_cast<mujoco_ros_msgs__msg__GeomProperties *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mujoco_ros_msgs__msg__GeomProperties(cdr, ros_message);
}
