  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mujoco_ros_msgs__msg__SolverParameters * ros_message = static_cast<const mujoco_ros_msgs__msg__SolverParameters *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mujoco_ros_msgs__msg__SolverParameters(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mujoco_ros_msgs__msg__SolverParameters * ros_message = static_cast<mujoco_ros_msgs__msg__SolverParameters *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mujoco_ros_msgs__msg__SolverParameters(cdr, ros_message);
}
