  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mujoco_ros_msgs__msg__StateUint * ros_message = static_cast<const mujoco_ros_msgs__msg__StateUint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mujoco_ros_msgs__msg__StateUint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mujoco_ros_msgs__msg__StateUint * ros_message = static_cast<mujoco_ros_msgs__msg__StateUint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mujoco_ros_msgs__msg__StateUint(cdr, ros_message);
}
