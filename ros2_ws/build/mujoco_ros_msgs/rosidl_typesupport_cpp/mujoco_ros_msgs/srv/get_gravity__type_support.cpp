...
static const _GetGravity_Event_type_support_symbol_names_t _GetGravity_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mujoco_ros_msgs, srv, GetGravity_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mujoco_ros_msgs, srv, GetGravity_Event)),
  }
};
...
{
  return &::mujoco_ros_msgs::srv::rosidl_typesupport_cpp::GetGravity_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mujoco_ros_msgs, srv, GetGravity_Event)() {
  return get_message_type_support_handle<mujoco_ros_msgs::srv::GetGravity_Event>();
}
...
static const rosidl_service_type_support_t GetGravity_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mujoco_ros_msgs::srv::GetGravity_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mujoco_ros_msgs::srv::GetGravity_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mujoco_ros_msgs::srv::GetGravity_Event>(),
