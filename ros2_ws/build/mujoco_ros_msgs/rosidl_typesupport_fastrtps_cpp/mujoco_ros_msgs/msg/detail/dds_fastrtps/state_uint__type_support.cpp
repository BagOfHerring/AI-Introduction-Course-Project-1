...
#include "mujoco_ros_msgs/msg/detail/state_uint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mujoco_ros_msgs::msg::StateUint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mujoco_ros_msgs::msg::StateUint & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mujoco_ros_msgs::msg::StateUint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mujoco_ros_msgs::msg::StateUint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mujoco_ros_msgs::msg::StateUint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StateUint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mujoco_ros_msgs::msg::StateUint *>(
...
static size_t _StateUint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StateUint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StateUint__callbacks = {
  "mujoco_ros_msgs::msg",
  "StateUint",
...
static rosidl_message_type_support_t _StateUint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StateUint__callbacks,
...
{
  return &mujoco_ros_msgs::msg::typesupport_fastrtps_cpp::_StateUint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mujoco_ros_msgs, msg, StateUint)() {
  return &mujoco_ros_msgs::msg::typesupport_fastrtps_cpp::_StateUint__handle;
}
