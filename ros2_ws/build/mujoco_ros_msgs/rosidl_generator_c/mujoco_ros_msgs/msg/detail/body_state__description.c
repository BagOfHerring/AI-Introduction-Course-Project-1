...
static char mujoco_ros_msgs__msg__BodyState__FIELD_NAME__name[] = "name";
static char mujoco_ros_msgs__msg__BodyState__FIELD_NAME__pose[] = "pose";
static char mujoco_ros_msgs__msg__BodyState__FIELD_NAME__twist[] = "twist";
static char mujoco_ros_msgs__msg__BodyState__FIELD_NAME__mass[] = "mass";

static rosidl_runtime_c__type_description__Field mujoco_ros_msgs__msg__BodyState__FIELDS[] = {
  {
    {mujoco_ros_msgs__msg__BodyState__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {mujoco_ros_msgs__msg__BodyState__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {mujoco_ros_msgs__msg__BodyState__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {mujoco_ros_msgs__msg__BodyState__FIELD_NAME__mass, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mujoco_ros_msgs__msg__BodyState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mujoco_ros_msgs__msg__BodyState__FIELDS, 4, 4},
    },
    {mujoco_ros_msgs__msg__BodyState__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
...
mujoco_ros_msgs__msg__BodyState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mujoco_ros_msgs__msg__BodyState__get_individual_type_description_source(NULL),
