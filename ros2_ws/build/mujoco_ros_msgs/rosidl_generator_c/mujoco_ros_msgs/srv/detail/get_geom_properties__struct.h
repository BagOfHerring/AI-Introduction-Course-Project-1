...
enum
{
  mujoco_ros_msgs__srv__GetGeomProperties_Event__request__MAX_SIZE = 1
};
// response
enum
{
  mujoco_ros_msgs__srv__GetGeomProperties_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetGeomProperties in the package mujoco_ros_msgs.
typedef struct mujoco_ros_msgs__srv__GetGeomProperties_Event
{
  service_msgs__msg__ServiceEventInfo info;
  mujoco_ros_msgs__srv__GetGeomProperties_Request__Sequence request;
  mujoco_ros_msgs__srv__GetGeomProperties_Response__Sequence response;
} mujoco_ros_msgs__srv__GetGeomProperties_Event;

// Struct for a sequence of mujoco_ros_msgs__srv__GetGeomProperties_Event.
typedef struct mujoco_ros_msgs__srv__GetGeomProperties_Event__Sequence
{
