...
class Metaclass_ResetBodyQPos_Event(type):
    """Metaclass of message 'ResetBodyQPos_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__reset_body_q_pos__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__reset_body_q_pos__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__reset_body_q_pos__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__reset_body_q_pos__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__reset_body_q_pos__event
...
class ResetBodyQPos_Event(metaclass=Metaclass_ResetBodyQPos_Event):
    """Message class 'ResetBodyQPos_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mujoco_ros_msgs/ResetBodyQPos_Request, 1>',
        'response': 'sequence<mujoco_ros_msgs/ResetBodyQPos_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mujoco_ros_msgs', 'srv'], 'ResetBodyQPos_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mujoco_ros_msgs', 'srv'], 'ResetBodyQPos_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mujoco_ros_msgs.srv import ResetBodyQPos_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ResetBodyQPos_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ResetBodyQPos_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from mujoco_ros_msgs.srv import ResetBodyQPos_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ResetBodyQPos_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ResetBodyQPos_Response'"
...
class Metaclass_ResetBodyQPos(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _reset_body_q_pos.Metaclass_ResetBodyQPos_Event._TYPE_SUPPORT is None:
                _reset_body_q_pos.Metaclass_ResetBodyQPos_Event.__import_type_support__()
...
class ResetBodyQPos(metaclass=Metaclass_ResetBodyQPos):
    ...
    from mujoco_ros_msgs.srv._reset_body_q_pos import ResetBodyQPos_Event as Event
