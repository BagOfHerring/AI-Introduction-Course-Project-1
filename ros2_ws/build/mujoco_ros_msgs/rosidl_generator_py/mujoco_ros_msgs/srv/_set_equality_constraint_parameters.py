...
class Metaclass_SetEqualityConstraintParameters_Event(type):
    """Metaclass of message 'SetEqualityConstraintParameters_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_equality_constraint_parameters__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_equality_constraint_parameters__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_equality_constraint_parameters__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_equality_constraint_parameters__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_equality_constraint_parameters__event
...
class SetEqualityConstraintParameters_Event(metaclass=Metaclass_SetEqualityConstraintParameters_Event):
    """Message class 'SetEqualityConstraintParameters_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mujoco_ros_msgs/SetEqualityConstraintParameters_Request, 1>',
        'response': 'sequence<mujoco_ros_msgs/SetEqualityConstraintParameters_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mujoco_ros_msgs', 'srv'], 'SetEqualityConstraintParameters_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mujoco_ros_msgs', 'srv'], 'SetEqualityConstraintParameters_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mujoco_ros_msgs.srv import SetEqualityConstraintParameters_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetEqualityConstraintParameters_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetEqualityConstraintParameters_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from mujoco_ros_msgs.srv import SetEqualityConstraintParameters_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetEqualityConstraintParameters_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetEqualityConstraintParameters_Response'"
...
class Metaclass_SetEqualityConstraintParameters(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_equality_constraint_parameters.Metaclass_SetEqualityConstraintParameters_Event._TYPE_SUPPORT is None:
                _set_equality_constraint_parameters.Metaclass_SetEqualityConstraintParameters_Event.__import_type_support__()
...
class SetEqualityConstraintParameters(metaclass=Metaclass_SetEqualityConstraintParameters):
    ...
    from mujoco_ros_msgs.srv._set_equality_constraint_parameters import SetEqualityConstraintParameters_Event as Event
