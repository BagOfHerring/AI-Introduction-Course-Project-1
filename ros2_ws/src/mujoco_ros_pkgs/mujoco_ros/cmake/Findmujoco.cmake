...
if((NOT DEFINED MUJOCO_DIR OR "${MUJOCO_DIR}" STREQUAL "") AND DEFINED ENV{HOME})
	file(GLOB _mujoco_home_candidates LIST_DIRECTORIES true "$ENV{HOME}/.mujoco/mujoco-*")
	list(SORT _mujoco_home_candidates COMPARE NATURAL ORDER DESCENDING)
	foreach(_candidate IN LISTS _mujoco_home_candidates)
		if(EXISTS "${_candidate}/include/mujoco/mujoco.h" AND EXISTS "${_candidate}/lib/libmujoco.so")
			set(MUJOCO_DIR "${_candidate}" CACHE PATH "Path to MuJoCo installation directory" FORCE)
			break()
		endif()
	endforeach()
endif()

set(_mujoco_manual_root FALSE)
if(DEFINED MUJOCO_DIR AND NOT "${MUJOCO_DIR}" STREQUAL "")
	set(_mujoco_manual_root TRUE)
	unset(mujoco_DIR CACHE)
	unset(mujoco_FOUND CACHE)
	unset(mujoco_FOUND)
endif()

if(NOT _mujoco_manual_root)
...
if(_mujoco_manual_root OR NOT mujoco_FOUND)
